...
if not BOT_TOKEN:
    raise ValueError("توکن ربات پیدا نشد! BOT_TOKEN را ست کن.")

WEBHOOK_URL = os.getenv("WEBHOOK_URL")
if not WEBHOOK_URL:
    raise ValueError("وبهوک پیدا نشد! WEBHOOK_URL را ست کن.")
...
async def handle_message(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    try:
        ...
        if "url" in res:
            await update.message.reply_video(video=res["url"], caption="اینجا ویدیوت 🎥")
        else:
            await update.message.reply_text(
